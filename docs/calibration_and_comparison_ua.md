...
- Удосконалена методика **підвищує грейд координованого проросійського вкиду з B
  ...
  (доменна належність до мережі + низька довіра за ІМІ) та $I_{coord}=0.703$
