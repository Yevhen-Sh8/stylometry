...
# Курований список ФУНКЦІОНАЛЬНИХ СЛІВ (прийменники, сполучники, частки,
# займенники, допоміжні дієслова, службові прислівники) — укр / рос / eng.
# Канонічне уточнення Burrows' Delta: порівняння за функціональними словами
# ізолює АВТОРСЬКИЙ СТИЛЬ від теми та залишкового сміття (вони майже не залежать
# від змісту й однакові для будь-якої теми). Включає однолітерні службові слова
# (в, у, з, і, я, не, же…), які звичайний токенайзер (len>1) відкидає. Розширюваний.
FUNCTION_WORDS = {
    # ── UA ──
    "в", "у", "на", "до", "з", "із", "зі", "за", "по", "при", "про", "від", "од",
    "для", "над", "під", "перед", "між", "через", "без", "після", "біля", "коло",
    "серед", "поза", "попри", "щодо", "окрім", "крім", "замість", "завдяки",
    "навколо", "поряд", "поруч", "протягом", "упродовж",
    "і", "й", "та", "а", "але", "проте", "однак", "зате", "або", "чи", "що", "щоб",
    "аби", "бо", "як", "якщо", "коли", "доки", "поки", "хоч", "хоча", "ніби",
    "нібито", "наче", "неначе", "мов", "немов", "тому", "адже", "отже", "тож",
    "тобто", "причому", "незважаючи",
    "не", "ні", "ані", "же", "ж", "би", "б", "хай", "нехай", "лише", "лиш",
    "тільки", "навіть", "саме", "ось", "от", "хіба", "невже", "мовляв", "мабуть",
    "таки", "аж", "ще", "вже", "уже",
    "я", "ти", "він", "вона", "воно", "ми", "ви", "вони", "мене", "тебе", "його",
    "її", "нас", "вас", "їх", "мені", "тобі", "йому", "їй", "нам", "вам", "їм",
    "мною", "тобою", "ним", "нею", "нами", "вами", "ними", "себе", "собі", "собою",
    "цей", "ця", "це", "ці", "той", "те", "ті", "такий", "така", "таке", "такі",
    "який", "яка", "яке", "які", "котрий", "хто", "чий", "мій", "моя", "моє", "мої",
    "твій", "наш", "ваш", "свій", "своя", "своє", "свої", "весь", "вся", "все",
    "всі", "увесь", "кожен", "кожний", "інший", "сам", "самий", "ніхто", "ніщо",
    "є", "був", "була", "було", "були", "буде", "будуть", "буду", "будеш",
    "будемо", "будете", "бути",
    "де", "тут", "там", "тоді", "тепер", "нині", "завжди", "ніколи", "скрізь",
    "так", "дуже", "більше", "менше",
    # ── RU ──
    "во", "с", "со", "к", "ко", "от", "ото", "под", "между", "меж", "после",
    "около", "возле", "среди", "кроме", "вместо", "благодаря", "вопреки", "вокруг",
    "рядом", "насчёт", "насчет", "относительно",
    "и", "но", "да", "или", "либо", "чтобы", "чтоб", "если", "когда", "пока",
    "хотя", "будто", "словно", "точно", "ибо", "потому", "поэтому", "итак",
    "значит", "причём", "причем", "несмотря", "тоже", "также", "однако",
    "ни", "бы", "ли", "пусть", "пускай", "лишь", "только", "даже", "именно", "вот",
    "вон", "разве", "неужели", "мол", "дескать", "ведь", "уж", "ещё", "еще",
    "ты", "он", "она", "оно", "мы", "вы", "они", "меня", "тебя", "его", "её", "ее",
    "нас", "вас", "их", "мне", "тебе", "ему", "ей", "нам", "вам", "им", "мной",
    "тобой", "ним", "ней", "нами", "вами", "ими", "себя", "себе", "собой", "этот",
    "эта", "это", "эти", "тот", "то", "те", "такой", "такая", "такое", "такие",
    "который", "кто", "что", "чей", "мой", "моя", "моё", "мое", "мои", "твой",
    "наш", "ваш", "свой", "своя", "своё", "свое", "свои", "весь", "вся", "всё",
    "все", "каждый", "иной", "другой", "сам", "самый", "никто", "ничто",
    "есть", "был", "была", "было", "были", "будет", "будут", "буду", "будешь",
    "будем", "будете", "быть",
    "где", "тут", "там", "тогда", "теперь", "ныне", "всегда", "никогда", "везде",
    "очень", "более", "менее",
    # ── EN ──
    "the", "a", "an", "of", "to", "in", "on", "at", "by", "for", "with", "from",
    "as", "into", "onto", "upon", "about", "above", "below", "over", "under",
    "before", "after", "between", "among", "through", "during", "without",
    "within", "against", "toward", "towards", "across", "behind", "beyond", "near",
    "off", "out", "up", "down",
    "and", "but", "or", "nor", "so", "yet", "that", "which", "who", "whom", "whose",
    "if", "when", "while", "because", "although", "though", "since", "unless",
    "until", "whereas", "however", "therefore", "thus", "hence", "moreover",
    "not", "no", "only", "even", "just", "very", "too", "also", "both", "either",
    "neither", "each", "every", "all", "any", "some", "such", "more", "most", "less",
    "i", "you", "he", "she", "it", "we", "they", "me", "him", "her", "us", "them",
    "my", "your", "his", "its", "our", "their", "mine", "yours", "hers", "ours",
    "theirs", "this", "these", "those", "what", "myself", "yourself", "himself",
    ...
    "there", "here", "then", "now", "always", "never", "often", "where", "why", "how",
}


def _function_word_tokens(text: str) -> list[str]:
    """Токени-функціональні слова (включно з однолітерними службовими, які
    звичайний токенайзер відкидає). Для feature_type='function'."""
    text = text.lower().translate(_STRIP_TABLE)
    return [t for t in text.split() if t in FUNCTION_WORDS]
...
def tokenise_corpus(
    ...
    feature_type: "word"     (default) → clean_and_tokenise (усі слова len≥2);
                  "function"           → лише функціональні слова (стиль, не тема);
    ...
    if feature_type == "function":
        return {label: _function_word_tokens(text) for label, text in corpus.items()}
